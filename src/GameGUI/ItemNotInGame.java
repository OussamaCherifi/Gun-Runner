...
public class ItemNotInGame extends ImageView {
    ...
    public ItemNotInGame(int b) throws FileNotFoundException {
        ...
        this.PossessedItem.setTextFill(Color.valueOf("2e732c"));
    ...
    public InGameItems toInGameItems(int id, double x, double y){
        switch(id){
            case 1:
            ...
            case 11:
                return new Gun("ak", x, y, 2, Custom.c1);
            case 12:
                return new Bullet("pistol", x, y, 2, Custom.c1, new Player(0));
        }
